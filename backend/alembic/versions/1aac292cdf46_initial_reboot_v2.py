...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'SUSPENDED', 'BANNED', 'PENDING', name='userstatus'), nullable=False),
    sa.Column('subscription_tier', sa.Enum('FREE', 'GOLD', 'PLATINUM', name='subscriptiontier'), nullable=False),
